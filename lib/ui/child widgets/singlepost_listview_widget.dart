...
class _ListViewWidgetState extends State<ListViewWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<CheriProvider>(builder: (context, cheriProvider, child) {
      return InkWell(
        onTap: () {
          Navigator.pushNamed(context, CheriDetailViewScreen.route, arguments: {
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              Container(
                margin:
                    EdgeInsets.only(left: 16, right: 10, top: 10, bottom: 5.0),
                width: 101,
                height: 100,
                decoration: BoxDecoration(
                      ...
                      ? InkWell(
                          onTap: () {
                            if (memberId != "")
                              cheriProvider
                                  .saveCheriPost(
                                      widget.post.cheriId, "Y", memberId)
                                  .then((value) {
                                if (value)
                                  setState(() {
                      ...
                      : InkWell(
                          onTap: () {
                            if (memberId != "")
                              cheriProvider
                                  .saveCheriPost(
                                      widget.post.cheriId, "N", memberId)
                                  .then((value) {
                                if (value) {
                                  setState(() {
